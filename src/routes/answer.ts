...
answerRoutes.post('/answer', (request: Request, response: Response) => {
    return createAnswerController.handle(request, response)
})

answerRoutes.get('/answer', (request: Request, response: Response) => {
    return findAllAnswersController.handle(request, response)
})

answerRoutes.get('/answer/:id', (request: Request, response: Response) => {
    return findAnswerByIdController.handle(request, response)
})

answerRoutes.delete('/answer/:id', (request: Request, response: Response) => {
    return deleteAnswerController.handle(request, response)
})

answerRoutes.put('/answer/:id', (request: Request, response: Response) => {
